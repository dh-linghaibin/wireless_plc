...
static lv_res_t btn_save_action(lv_obj_t * btn) {
    ...
    lv_mbox_set_text(mbox1, "Time set OK !\n");                    /*Set the text*/
    /*Add two buttons*/
...
void time_set_create(void) {
    ...
    style_sb.text.font = &sy_china;   /*Unicode and symbol fonts already assigned by the library*/
    
    lv_obj_t * win = lv_win_create(lv_scr_act(),NULL);
    lv_win_add_btn(win,SYMBOL_CLOSE,lv_win_close_action_animation);
    lv_win_set_title(win,"time set");
    ...
    lv_obj_align(roller[0],win,LV_ALIGN_IN_LEFT_MID,10,0);
    
    lab_roller[0] = lv_label_create(win,NULL);
    
    lv_obj_set_style(lab_roller[0],&style_sb);
    
    lv_label_set_text(lab_roller[0],"日子");
    ...
    lv_obj_align(roller[1],roller[0],LV_ALIGN_OUT_RIGHT_MID,10,0);
    
    lab_roller[1] = lv_label_create(win,NULL);
    lv_label_set_text(lab_roller[1],"month");
    ...
    lv_obj_align(roller[2],roller[1],LV_ALIGN_OUT_RIGHT_MID,10,0);
    
    lab_roller[2] = lv_label_create(win,NULL);
    lv_label_set_text(lab_roller[2],"date");
    ...
    lv_label_set_text(lab_roller[3],"hour");
    ...
    lv_roller_set_visible_row_count(roller[1],3);
    lv_obj_align(roller[4],roller[3],LV_ALIGN_OUT_RIGHT_MID,10,0);
    
    lab_roller[4] = lv_label_create(win,NULL);
    lv_label_set_text(lab_roller[4],"min");
    ...
    lv_obj_align(roller[5],roller[4],LV_ALIGN_OUT_RIGHT_MID,10,0);
    
    lab_roller[5] = lv_label_create(win,NULL);
    lv_label_set_text(lab_roller[5],"sec");
    ...
    lv_label_set_text(label_save,SYMBOL_SETTINGS"  #ffffff set#");
