...
#define FLASH_START        ((uint32_t)(0x08000000 + 0x03000)) /* flash获取地址62k */
static uint32_t page_merry[1];                   /* 内存缓冲 */
...
//        addr+=4;
//    } while(++read_i < 256);//256
//        
//    FLASH_ErasePage(page_num*1024 + FLASH_START); /* 擦除 */
//    page_offset = address%PAGE_SIZE;
//    page_merry[page_offset] = data;
//    addr = (page_num*1024 + FLASH_START);
//    read_i = 0;
//    do{
//        FLASH_ProgramHalfWord(addr,page_merry[read_i]);
//        addr += 4;
//    }while(++read_i < 256);
//    
